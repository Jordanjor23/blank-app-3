...
if password == "Jordan25":
    ...
    page = st.sidebar.selectbox("Select a page", ['Home', "FP&A Software Selection Overview", "AI Comparison","Final Thoughts"])
...
if page == "Home":
        ...
        st.image('./Impellam logo.png', caption="Impellam Group Logo")
        st.write("This project aims to compare two AI FP&A softwares: Datarails and Adaptive Insights. The goal is to provide a comprehensive overview of their capabilities, benefits, and challenges in the context of financial planning and analysis.")
        st.write("The project will include an overview of the software selection process, a comparison of the two AI solutions, and final thoughts on the best fit for the FP&A department at Impellam Group.")
        st.write("The project will also explore how these AI solutions can enhance financial data analysis, improve reporting efficiency, and support strategic decision-making within the organization.")
        ...
        st.write("Welcome to the Home Page of my steamlit for the FP&A Software Selection Project. The purpose of this app is to compare the benefits and challenges of two AI FP&A softwares: Datarails and Adaptive Insights!")
            ...
            st.write("This page will discuss Final Thoughts about the Impellam Software Selection Project.")
